dir_segemented_tmp1 = r'.\DATA\Embryo04LabelUnified'

dir_my_data = r'.\DATA\my_data'

dir_my_data_R_matrix_csv = r'./DATA/my_data_csv/R_matrix'

dir_my_data_SH_PCA_csv = r'.\DATA\my_data_csv\SH_PCA_csv'

dir_my_data_all_embryo = r'./DATA/SegmentCellUnified04-20'
